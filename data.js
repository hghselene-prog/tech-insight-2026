...
var SITE = {
  ...
  pc: {
    ...
    blocks: [
      { type: "hwlist", filterHint: "<b>怎么用这页：</b>① <b>时间</b>——看最新动态选「近30天」；标为 ⭐长期关注 与所有「未发布」条目不会被时间筛选隐藏。② <b>信号强度（四档）</b>——这是本页的核心维度，按可信度从高到低分：<b>✅ 已上市</b>（可买到 / 已正式落地）→ <b>📢 已官宣</b>（厂商官方确认在做或已定档，尚未上市）→ <b>🏭 权威爆料</b>（供应链，或有长期准确记录的记者与分析师：彭博 Gurman、天风郭明錤、The Information、AR圈等，非官方口径）→ <b>🔶 早期传闻</b>（单一/匿名来源，未交叉验证）。点「🔭 未发布」可一次性看全部在研内容——这是提前半年到两年看清方向的地方。③ 每条未发布条目都带 <b>🔬 对研究的意义</b>，说明它为什么值得你看，而不只是罗列爆料。④ 平板模块仍为🚧占位。",
        modules: [
          ...
          { id: "aihw", name: "AI 智能硬件", icon: "🤖", note: "本模块重点在「大模型 / agent 厂家亲自下场的 AI 原生硬件」（OpenAI、字节豆包、阶跃、Meta、小米、华为、百度、阿里、科大讯飞等）——它们要把 ChatGPT / 豆包 / 智能体变成「超级入口」，重构终端而非加附件。普通配件型 AI 硬件（耳机 / 云台 / 小键盘）价值有限，已降级为次要子类（🚧 占位）。",
            subs: [
              { cat: "★ 大模型 / agent 厂家的 AI 原生硬件（重点）", items: [
                ...
                { name: "OpenAI · Codex Micro 编程键盘（首款 AI 硬件）", brand: "OpenAI", date: "2026-07-15", level: "new", certainty: "shipped",
                ...
                { name: "Anthropic · Claude Desktop Buddy + 官方推荐 Cardputer", brand: "Anthropic", date: "2026-05-23", level: "long", certainty: "shipped",
              ...
              { cat: "🔭 研究雷达｜在研 / 未发布（含权威爆料与早期传闻）", items: [
                { name: "Apple · N50 智能眼镜（Project Atlas）", brand: "Apple", date: "2027-06(预计)", level: "long", certainty: "supply",
                  summary: "彭博社 Gurman：内部代号 N50，原定 2026 年底推出，因隐私方案打磨推迟至 2027 年 6 月 WWDC 发布、年底量产上市。核心是「无屏设计」——更像一副长得像眼镜的高级 AirPods，交互中心在音频 + Apple Intelligence，需搭配 iPhone。带显示的 Vision Air 预计 2029。摄像头方案苹果内部在权衡三套：①彻底移除摄像头 ②保留硬件但不能拍照录像 ③保留录制但强制常亮 LED + 提示音。郭明錤口径一致：2027 AI 眼镜、2029 Vision Pro 继任者。",
                  why: "苹果放弃 AR 显示、选择「无屏 + 环境感知 + 语音」，是主流大厂对「AI 原生终端第一形态」的判断：<b>传感器优先、显示其次</b>。对桌面算力形态的启示是——决定体验上限的不是屏幕，而是「感知通道 + 本地推理」这条链路是否闭环。",
                  src: { n: "电子发烧友·N50 推迟至 2027", u: "https://m.elecfans.com/article/8162747.html" },
                  src2: { n: "Smart Glasses Daily·Apple 时间线汇总", u: "https://smartglassesdaily.com/zh/brand/apple" } },
                { name: "Apple · H90 带红外传感器 AirPods", brand: "Apple", date: "2026-09(预计)", level: "long", certainty: "supply",
                  summary: "Gurman 于 2026-05-08 证实已进入 DVT（设计验证测试），员工内部 dogfooding，最快 2026 秋随 iOS 27 一同发布，研发可追溯到四年前。关键点：装的不是普通摄像头，而是低分辨率红外传感器（与 Face ID 同源）——不拍照、不录像、不存图，只扫描环境深度/轮廓/动静，喂给 H3 芯片做端侧推理，苹果把这套体验命名为「环境智能 ambient intelligence」。⚠️ 但供应链同日消息称 H90 部分产线因欧盟 GDPR 合规压力「原地解散」，多数分析认为是节奏调整而非取消。",
                  why: "两层价值：① 证明「端侧感知 + 本地推理、全程不依赖云端」已走到量产验证阶段，不再是 PPT；② 暴露了 AI 硬件最大的<b>非技术</b>障碍是隐私合规——欧盟法院 2025-12 判决要求公共场合被动采集须即时告知，这一条几乎判了所有 always-on 传感器的死刑。做本地算力设备反而在这点上占优：数据不出户。",
                  src: { n: "澎湃·苹果 AI 硬件首秀押注 AirPods", u: "https://m.thepaper.cn/newsDetail_forward_33141633" },
                  src2: { n: "搜狐·AI 硬件重生潮", u: "https://m.sohu.com/a/1030108736_602994" } },
                { name: "Apple · AI 吊坠（AirTag 尺寸）", brand: "Apple", date: "2026-2027", level: "long", certainty: "supply",
                  summary: "Bloomberg / LA Times：AirTag 大小，可当项链佩戴或别在衣服上，内置 always-on 摄像头与麦克风，依赖 iPhone 处理数据，通过 iOS 27 版 Siri 语音交互。苹果内部称它是 iPhone 的「眼睛和耳朵」。三款 AI 可穿戴（眼镜 / 吊坠 / AirPods）共享同一逻辑：不取代 iPhone，而是在人体周围铺一张多模态感知网。",
                  why: "吊坠形态在 Humane AI Pin 惨败后被苹果、Meta（收购 Limitless）同时复活——说明<b>失败的不是形态，是「形态背后没有模型和生态」</b>。这条对判断新品类生死的标准很关键：先问它接的是谁的模型、复用谁的生态，再问它长什么样。",
                  src: { n: "今日头条·苹果造 AI 三件套", u: "https://www.toutiao.com/article/7637492820823048746" } },
                { name: "OpenAI · 首款硬件 Sweet Pea（官方定档 2026 下半年）", brand: "OpenAI", date: "2026-H2", level: "long", certainty: "announced",
                  summary: "📢 官方口径：OpenAI 首席全球事务官 Chris Lehane 在达沃斯确认，正按计划推进、2026 年下半年推出首款 AI 硬件。🏭 供应链/媒体口径（未获官方确认）：代号 Sweet Pea，是一台「外形像耳机的计算机」，对标 AirPods，采用定制 2nm 处理器在本地完成 AI 任务、不依赖云端，目标上市首年出货 4000–5000 万台。前提是 2025/5 以约 65 亿美元收购 Jony Ive 的 io，并从苹果挖走 20+ 名消费硬件员工（含 Vision Pro 硬件副总裁 Paul Meade）。",
                  why: "这条是<b>「怎么分辨真假消息」的标准样本</b>：时间点是官方说的（可信），形态/芯片/出货量是供应链说的（待验证）。跟踪时把两层拆开记，不要混成一句「OpenAI 要发耳机」。另外 4000–5000 万台的首年目标 = 直接对标 AirPods 体量，这个数字若属实，意味着 OpenAI 认为 AI 硬件已过临界点。",
                  src: { n: "知乎·OpenAI 字节盯上 AI 硬件", u: "https://zhuanlan.zhihu.com/p/2000621662173938051" },
                  src2: { n: "Cult of Mac·Sweetpea 传闻", u: "https://www.cultofmac.com/news/openais-first-device-might-take-on-airpods" } },
                { name: "OpenAI · 无屏智能音箱 / 录音笔 / 胸针 / 智能灯 / AI 笔", brand: "OpenAI", date: "2026末-2027", level: "long", certainty: "supply",
                  summary: "立讯精密已获得至少一款 OpenAI 设备的组装合同；OpenAI 还与歌尔股份接洽扬声器模块。规划产品包含：类似无显示屏的智能音箱（定价 $200–300，2027 上市）、数字录音笔、可穿戴胸针、智能眼镜，甚至智能灯与 AI 笔。首批设备发布定在 2026 年末或 2027 年初；硬件团队 200+ 人。",
                  why: "OpenAI 一次铺 5 种以上形态，本身就是最强的信号：<b>连它也没想清楚 AI 原生硬件的终局形态是什么</b>，只能广撒网试。这意味着形态窗口期仍然开着——桌面算力盒这类「非可穿戴」路线并没有被提前判死刑，反而在「隐私 + 持续算力 + 不需要戴」上有独立生态位。",
                  src: { n: "钛媒体·立讯精密拿下 OpenAI 硬件订单", u: "https://tmtpost.com/nictation/7700505.html" } },
                { name: "OpenAI · 自研 AI 手机（2028 量产）", brand: "OpenAI", date: "2028(预计)", level: "long", certainty: "supply",
                  summary: "郭明錤等多方爆料：OpenAI 正与联发科、高通合作开发手机处理器（2nm），委托立讯精密独家代工，首款产品预计 2028 年量产。OpenAI 给出的理由很明确——现有智能手机受限于<b>权限沙箱</b>，无法为 AI 提供实时、全面的用户状态数据。眼镜排在最后，预计 2028 年之后。",
                  why: "「沙箱限制」这四个字是整页最值得记的一条。<b>任何想做全局 agent 的产品，最终都会撞上操作系统权限这堵墙</b>——这解释了为什么大模型厂宁可自己造手机/造 OS（阶跃 Step AOS、字节豆包手机助手被 App 限制），也解释了桌面本地算力设备的机会：在自己的设备上，agent 天然拥有全权限。",
                  src: { n: "搜狐·AI 硬件重生潮（OpenAI 手机）", u: "https://m.sohu.com/a/1030247569_362225" },
                  src2: { n: "腾讯新闻·OpenAI 挖走 Vision Pro 老大", u: "https://new.qq.com/rain/a/20260701A01ZFG00" } },
                { name: "Meta · Artemis AR 眼镜 / Phoenix MR / SSG 超感知眼镜 / Hypernova 2", brand: "Meta", date: "2026-2027", level: "long", certainty: "supply",
                  summary: "内部正在测试两款原型：传闻已久的 AR 眼镜 Artemis，以及代号 SSG 的「超感知」眼镜，均搭载最新模型 Muse Spark + 消费级助手 Hatch。但 Meta 在做减法：MR 眼镜 Phoenix 与 AR 眼镜 Artemis 都推迟到 2027，2026 年只留新版 Ray-Ban Display（代号 Hypernova 2）。2026 年另计划 6 款新 SKU（含一款无摄像头的纯音频款）、Modelo / Luna / RBM2 Refresh 迭代款与年底 Mojito VIP 高端款；产能要求 2026 年底翻倍到 2000 万副/年，下半年目标出货 1000 万台、年底月活 680 万。",
                  why: "Meta 是这条赛道上<b>唯一有真实规模数据的玩家</b>（2025 全球 AI 眼镜出货约 800–870 万副，Ray-Ban Meta 占 85%），所以它的「减法」信息量极大：把 AR/MR 全部推迟到 2027，等于用真金白银承认<b>显示技术还没到消费级临界点</b>。想判断 AR 何时成熟，盯 Meta 的排期比听任何白皮书都准。",
                  src: { n: "搜狐·Meta 原型 Artemis 与 SSG", u: "https://m.sohu.com/a/1030247569_362225" },
                  src2: { n: "搜狐·Meta 减法与 Malibu 2", u: "https://m.sohu.com/a/1030108736_602994" } },
                { name: "Meta · Malibu 2 智能手表（重启）", brand: "Meta", date: "2026(预计)", level: "long", certainty: "supply",
                  summary: "扎克伯格在夏威夷战略会上官宣放弃元宇宙，同时重新捡起 2022 年砍掉的智能手表项目：代号 Malibu 2，预计 2026 年发布，带健康追踪、内置 Meta AI，直接去抢苹果和谷歌的用户。五年前 Meta 曾一口气规划三款带摄像头的手表，因 Reality Labs 砍预算全部流产。",
                  why: "Meta 从「头部」扩到「腕部」，说明入口之争的打法是<b>多点位铺设、不赌单一形态</b>。同时「放弃元宇宙 + 重启手表」是一次公开的战略认错——大厂的战略转弯往往先体现在这种「重启旧项目」上，比新品发布更值得留意。",
                  src: { n: "搜狐·Meta 重启智能手表 Malibu 2", u: "https://m.sohu.com/a/1030108736_602994" } },
                { name: "Anthropic · 自研可穿戴（已核查：截至 2026-08 无可靠信号）", brand: "Anthropic", date: "—", level: "long", certainty: "rumor",
                  summary: "🔍 核查结论：公开渠道截至 2026-08 <b>没有</b> Anthropic 自研键盘或耳机的可靠爆料。容易混淆的三件真事是：① OpenAI 的 Codex Micro 编程键盘（真实，已发货）；② OpenAI 的 Sweet Pea 耳机（供应链爆料）；③ Anthropic 自己的 Claude Desktop Buddy 开源项目 + 官方推荐 M5Stack Cardputer 作参考硬件。市面上的「ClaudeCode 小键盘」是第三方集成产品，非 Anthropic 官方。",
                  why: "Anthropic 的「没动作」本身就是一条<b>负向信号</b>，而且是有价值的那种：在所有同行都下场造硬件时，它选择「软件 agent + 官方推荐第三方硬件」——不自己烧硬件的钱，用开源项目把 Claude 接到别人的设备上。这是与 OpenAI 完全相反的路径假设，值得作为对照组长期跟踪：如果两年后 Anthropic 仍不造硬件且份额未失，说明「入口论」被高估了。",
                  src: { n: "腾讯新闻·Claude 官方推荐 Cardputer", u: "https://news.qq.com/rain/a/20260523A09SXA00" } },
                { name: "字节 · 第二代豆包 AI 眼镜（全功能版 + 20 克轻量版）", brand: "字节跳动", date: "2026-H2", level: "long", certainty: "supply",
                  summary: "一代在 2026 年 4 月发布前夜、量产前夕被内部叫停（研发已投入超 5000 万元、首批规划 10 万台）。叫停原因不是做不出来，而是内部评审认定与阿里千问 G1、小米、Rokid、Ray-Ban Meta 同质化严重，没有属于豆包的独家体验。二代推倒重来：拆成「全功能版（摄像头+扬声器+麦克风）」与「轻量版（砍扬声器，压到 20 多克）」两个 SKU；芯片从「恒玄 BES2800 + 研极微 ISP」换成「高通 AR1 + 恒玄 BES2800」；代工从歌尔股份换成龙旗科技；由收购来的 Oladance 团队主导，三代已排到 2027。",
                  why: "两条硬信息：① <b>同质化是当前 AI 硬件最大的杀手</b>——字节宁可废掉 5000 万也不发平庸产品，这个案例比任何市场报告都有说服力，做新品类必须先回答「不可替代的那一点是什么」；② 芯片从 BES2800 升到「高通 AR1 + BES2800」双芯，是为了扛住「AI 一直在听、一直在看」的常驻感知——<b>常驻推理的功耗账</b>是所有端侧 AI 硬件绕不开的门槛。",
                  src: { n: "腾讯新闻·独家：字节叫停一代豆包眼镜", u: "https://new.qq.com/rain/a/20260715A02DO900?refer=cp_1009" },
                  src2: { n: "IT之家/网易·豆包眼镜双版本重来", u: "https://www.163.com/dy/article/L1TIOSMB0511B8LM.html" } },
                { name: "字节 · PICO 光波导显示眼镜（第二条产品线）", brand: "字节跳动", date: "待定", level: "long", certainty: "supply",
                  summary: "与 Oladance 负责的无显示线并行，PICO 团队单独啃光波导显示眼镜，攻显示、光学、空间交互。龙旗科技为此专门搭建 SiP 系统级封装团队，攻 AR 光学与本地 AI 算力集成，计划 2026 年底 SiP 产品量产、2027 年逐步释放产能。",
                  why: "「两支队伍两种赌法」是大厂面对形态不确定性的标准打法：<b>一条腿抢已被验证的市场（无显示），一条腿啃想象空间大但难的（光波导）</b>。判断一家公司是否真心投入某赛道，看它是否愿意同时养两条互相冲突的产品线——这比 CEO 表态可靠得多。",
                  src: { n: "腾讯新闻·Oladance 与 PICO 两条线", u: "https://new.qq.com/rain/a/20260715A02DO900?refer=cp_1009" } },
                { name: "阿里千问 · Qwen Clip 智能体耳机（与 Bose 联合）+ AI 指环", brand: "阿里", date: "2026 年内", level: "long", certainty: "announced",
                  summary: "WAIC 2026（7/17）首日，千问首款 AI 智能体耳机 Qwen Clip 首次公开亮相：开放式耳夹形态，由千问与 Bose 联合打造、Bose 全程负责声学调校。关键点是它<b>不是独立产品</b>——与智能体眼镜共用同一套多模态大模型底座，形成「眼镜视觉感知 + 耳机语音采集」的多模态闭环，核心功能为实时同传、会议纪要自动生成、全天候健康体征记录。目前未公布定价与上市时间。阿里另规划 AI 指环，明确提出「眼镜 + 耳机 + 指环」三终端协同战略。",
                  why: "阿里是目前唯一把<b>「多设备共享同一模型底座」</b>说透的厂商，这正是个人算力网络的雏形——设备只是采集与呈现端点，智能在同一个底座里。对做算力中枢形态的产品来说，这条是最直接的对标：阿里把底座放在云 + 手机，而本地算力盒的差异化就在于把这个底座<b>搬回用户自己家里</b>。",
                  src: { n: "今日头条·千问升级智能体眼镜，首发智能体耳机", u: "https://www.toutiao.com/article/7664593617155031592/" } },
                { name: "千问 · 智能体眼镜量产机型（行业首个眼镜端体征监测）", brand: "阿里", date: "2026 年内", level: "long", certainty: "announced",
                  summary: "基于 S1 系列迭代：镜框 51g、4000 尼特近眼显示、1200 万像素摄像头，首创热插拔可换电 + 便携换电仓实现全天候续航。最核心的变化在传感器——内置 PPG、温度传感器，集成高精度眼动追踪与蚂蚁集团的虹膜识别模块，成为行业首个支持眼镜端体征实时监测（心率、血氧、体温）的产品。千问 AI 硬件产品总监吴建军明确否定「套壳 AI 硬件」逻辑。已售 S1（4599 元）、G1 将通过 OTA 升级获得 Agent 能力。",
                  why: "从「加个 AI 」升级到「加传感器 + 加身份认证（虹膜）」，是 AI 眼镜第二阶段的分水岭：<b>价值从「问答」转向「持续采集独占数据」</b>。虹膜 + 体征这两类数据手机拿不到，这才是硬件相对 App 的真壁垒——判断一款 AI 硬件值不值得关注，就看它能不能拿到手机拿不到的数据。",
                  src: { n: "今日头条·WAIC 2026 千问智能体眼镜", u: "https://www.toutiao.com/article/7664593617155031592/" } },
                { name: "网易有道 · Youdao OpenPods AI 耳机", brand: "网易有道", date: "2026-08(预计)", level: "long", certainty: "announced",
                  summary: "WAIC 2026 首次公开亮相的开放式 AI 耳机。现场演示：模拟跨国通话时耳机实时完成中英同传，通话结束后 App 内已生成带发言人区分的会议纪要、自动提取待办事项，并同步输出思维导图，还能对会议中的专业术语做识别与纠错。有道方面透露预计 8 月正式亮相并公布定价与发售信息。产品底层逻辑不是「听」，而是「声音怎么变成生产力」。",
                  why: "在一堆讲不清 ROI 的 AI 硬件里，<b>「声音 → 结构化纪要 → 待办」是少数能算清账的场景</b>：省的是每天开会后 20 分钟的整理时间，可量化、可复购。做任何 AI 硬件都该先找到这样一条「能被秒懂的省时账」，否则就是字节一代豆包眼镜的下场。",
                  src: { n: "WAIC 2026 现场·有道 OpenPods 首发", u: "https://weibo.com/1912017873/5321971760895809" } },
                { name: "闪极 loomos · AI 眼镜新品发布会（8/18 定档）", brand: "闪极", date: "2026-08-18", level: "new", certainty: "announced",
                  summary: "闪极 2026-08-03 官宣，全新子品牌 loomos AI 眼镜发布会定档 8 月 18 日 19:30，官方称之为「好看的不像 AI 眼镜发布会」。已发布产品线：loomos AI 拍摄眼镜 L1（2999 元，镜腿窄至 10mm，无音腔一体扬声器，LoomOS 2.0 全天候主动 AI 录制）、AI 显示眼镜 S1（3999 元，29g，单光机双目异显做 3D 效果，0.02cc 超小扬声器，镜腿可拆卸换电，2026 年第三季度开售）。",
                  why: "创业公司的价值在于<b>敢做大厂不敢做的取舍</b>（10mm 超窄镜腿、可拆卸换电、0.02cc 扬声器）。这些工程解法往往一两年后被大厂抄走——盯创业公司看「解法」，盯大厂看「排期」，是两种不同的情报用法。",
                  src: { n: "IT之家·loomos 发布会定档 8/18", u: "https://so.html5.qq.com/page/real/search_news?docid=70000021_6646a702ab625652" } }
              ] },
    ...
    insights: [
      ...
      { type: "good", html: "<b>洞察 7 · 「已上市」只是结果，「未发布」才是方向——所以本页把信号分成四档：</b>确定消息往往已经晚于产业真实动作 1–2 个季度：苹果 H90 在 2026-05 就进了 DVT、字节一代豆包眼镜在量产前夜被砍，这些决定产业走向的动作，等到官宣时早已尘埃落定。所以本页把确定性拆成「✅ 已上市 / 📢 已官宣 / 🏭 权威爆料 / 🔶 早期传闻」四档，并新增「🔭 研究雷达」子模块，收录 15 条在研与未发布项目（苹果 N50+H90+吊坠、OpenAI Sweet Pea+音箱+自研手机、Meta Artemis+SSG+Malibu 2、字节二代豆包眼镜+PICO 光波导、阿里 Qwen Clip+AI指环、有道 OpenPods、闪极 loomos）。关键在于<b>分档而不是过滤</b>——不因为「没确认」就丢掉，也不因为「有人说」就当结论；每条都标了来源层级，你自己判断权重。", src: { n: "澎湃·苹果 H90 进入 DVT", u: "https://m.thepaper.cn/newsDetail_forward_33141633" } },
      { type: "", html: "<b>洞察 8 · 从 15 条在研项目里读出的三条真信号：</b>① <b>形态还没收敛</b>——OpenAI 一家就同时铺耳机、音箱、录音笔、胸针、智能灯、AI笔、手机 7 种形态，连它都在广撒网，说明「AI 原生硬件长什么样」这个问题<b>还没有答案，窗口期仍然开着</b>；② <b>显示技术未到临界点</b>——Meta 是唯一有真实规模数据的玩家（2025 全球 AI 眼镜出货约 870 万副、其占约 85%），它把 AR 眼镜 Artemis 和 MR 眼镜 Phoenix 全部推迟到 2027，只留无显示的 Ray-Ban 线，这是用真金白银投的反对票；③ <b>真正的墙是权限与合规，不是算力</b>——OpenAI 造手机的公开理由是「手机权限沙箱让 AI 拿不到实时用户状态」，苹果 H90 部分产线因欧盟 GDPR 压力停摆，字节豆包手机助手因越权操作被部分 App 限制。三件事指向同一个结论：<b>下一代 AI 硬件的竞争，打的是「能不能合法且无阻碍地拿到数据」</b>，这恰恰是本地/端侧算力路线的结构性优势——数据不出户，天然绕开这堵墙。", src: { n: "钛媒体·立讯精密拿下 OpenAI 硬件订单", u: "https://tmtpost.com/nictation/7700505.html" } },
    ],
    sources: [
